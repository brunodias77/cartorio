...
export const Sidebar = () => (
    <aside className="fixed hidden lg:flex flex-col top-0 left-0 h-full w-64 bg-white border-r border-slate-200 text-white z-30">
        ...
        <div className="p-4 space-y-2">
            ...
            {/* <div className="px-4 py-3 text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl text-sm font-medium flex items-center gap-3 transition-colors cursor-pointer">
                <User size={18} />
                Clientes
            </div> */}
        </div>
